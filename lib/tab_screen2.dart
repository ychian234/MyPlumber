...
import 'package:my_plumber/newjob.dart';
...
class _TabScreen2State extends State<TabScreen2> {
                                ...
                                Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                            fit: BoxFit.fill,
                                            image: NetworkImage(
                                                "http://mobilehost2019.com/MyPlumber2/images/${data[index]['jobimage']}.jpg")))),
                                Expanded(
                                  child: Container(
                                    child: Column(
                                      children: <Widget>[
  ...
  Future<String> makeRequest() async {
    String urlLoadJobs =
        "http://mobilehost2019.com/MyPlumber2/php/load_job_user.php";
  ...
  Future<String> deleteRequest(String jobid) async {
    String urlLoadJobs =
        "http://mobilehost2019.com/MyPlumber2/php/delete_job.php";
    ProgressDialog pr = new ProgressDialog(context,
        type: ProgressDialogType.Normal, isDismissible: false);
